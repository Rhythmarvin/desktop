...
- Concrete repositories map projects, tasks, sessions, skills, configurable agents, worktrees, task diff comments, and typed user preferences between SQL rows and application values.
