...
`Workflow` and `WorkflowSnapshot` are the newest additions, implementing draft-as-workspace semantics with immutable published snapshots. See [Workflow](workflow.md).
