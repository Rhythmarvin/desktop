...
export const translationResources = {
  "zh-CN": {
    ...
    "workflowRun.result.title.partial_failed": "部分步骤未成功",
    ...
    "workflowRun.result.body.partial_failed": "部分步骤未成功；详情见路径。此处不做聚合统计。",
  ...
  "en-US": {
    ...
    "workflowRun.result.title.partial_failed": "Partial failure",
    ...
    "workflowRun.result.body.partial_failed": "Some steps did not succeed; see the path for details. No aggregate stats here.",
