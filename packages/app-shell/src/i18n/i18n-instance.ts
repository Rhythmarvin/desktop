...
export const translationResources = {
  "zh-CN": {
    ...
    "workflowRun.placeholderBody": "节点舞台、全图俯瞰、产物与人机协作将在后续步骤接入。当前可从侧栏进入已创建的运行。",
  ...
  "en-US": {
    ...
    "workflowRun.placeholderBody": "Theater, overview, artifacts, and human-in-the-loop arrive in later steps. You can already open created runs from the sidebar.",
