...
export const translationResources = {
  "zh-CN": {
    ...
    "workflowRun.skippedCount": "跳过 {{count}}",
    ...
    "workflowRun.theater.parallelHint": "{{count}} 个节点并行 · 当前 {{index}}/{{count}}，可切换查看",
    ...
    "workflowRun.nodeStatus.skipped": "已跳过",
    ...
    "workflowRun.status.partial_failed": "部分失败",
    ...
    "workflowRun.deployDescription": "将“{{name}}”部署到项目：每个项目对同一工作流只保留一份挂载；每次确认都会在侧栏新建一次待启动的运行。",
    ...
    "workflowRun.deployGroupMounted": "已挂载 · 再部署将创建新运行",
    "workflowRun.deployGroupOther": "其他项目",
    "workflowRun.deployHintFirst": "将挂载此工作流，并创建该项目下的首次运行（不会自动启动）。",
    "workflowRun.deployHintRemount": "此项目已挂载该工作流。确认后会更新定义快照，并再创建一次新运行（不会自动启动）。",
    "workflowRun.deployConfirmFirst": "挂载并创建运行",
    "workflowRun.deployConfirmAgain": "创建新运行",
  ...
  "en-US": {
    ...
    "workflowRun.placeholderBody": "Theater and graph overview are live; artifacts and HITL arrive in later steps.",
    ...
    "workflowRun.theater.parallelHint": "{{count}} in parallel · {{index}}/{{count}} — switch to inspect",
    ...
    "workflowRun.nodeStatus.skipped": "Skipped",
    ...
    "workflowRun.status.partial_failed": "Partial failure",
    ...
    "workflowRun.deployDescription": "Deploy “{{name}}” to a project: one mount per project for this workflow; every confirm creates a new pending sidebar run.",
    ...
    "workflowRun.deployGroupMounted": "Already mounted · deploy creates a new run",
    "workflowRun.deployGroupOther": "Other projects",
    "workflowRun.deployHintFirst": "Mount this workflow and create the first run under the project (does not start automatically).",
    "workflowRun.deployHintRemount": "Already mounted here. Confirm refreshes the definition snapshot and creates another run (does not start automatically).",
    "workflowRun.deployConfirmFirst": "Mount and create run",
    "workflowRun.deployConfirmAgain": "Create new run",
