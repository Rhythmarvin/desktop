...
export const translationResources = {
  "zh-CN": {
    ...
    "settings.workflow.dropNode": "释放以添加节点",
    ...
    "settings.workflow.manageError": "操作失败，请重试。",
    ...
    "settings.workflow.testRun": "测试运行",
    "settings.workflow.saved": "已保存",
    "settings.workflow.loading": "正在加载 mock 工作流…",
    ...
    "settings.workflow.canvasHint": "滚轮缩放 · 拖拽移动",
    ...
    "settings.workflow.localModel": "本地模型",
    ...
    "settings.workflow.defaultCondition": "满足条件",
    "settings.workflow.kind.start": "开始",
    "settings.workflow.kind.startDescription": "定义工作流输入",
    "settings.workflow.kind.prompt": "提示词",
    "settings.workflow.kind.promptDescription": "处理和转换文本",
    "settings.workflow.kind.agent": "Agent",
    "settings.workflow.kind.agentDescription": "交给模型自主执行",
    "settings.workflow.kind.condition": "条件分支",
    "settings.workflow.kind.conditionDescription": "根据规则选择路径",
    "settings.workflow.kind.tool": "工具",
    "settings.workflow.kind.toolDescription": "调用终端或插件",
    "settings.workflow.kind.output": "输出",
    "settings.workflow.kind.outputDescription": "返回最终结果",
  ...
  "en-US": {
    ...
    "settings.workflow.dropNode": "Release to add node",
    ...
    "settings.workflow.manageError": "The action failed. Please try again.",
    ...
    "settings.workflow.testRun": "Test run",
    "settings.workflow.saved": "Saved",
    "settings.workflow.loading": "Loading mock workflow…",
    ...
    "settings.workflow.canvasHint": "Scroll to zoom · Drag to pan",
    ...
    "settings.workflow.localModel": "Local model",
    ...
    "settings.workflow.defaultCondition": "Condition is met",
    "settings.workflow.kind.start": "Start",
    "settings.workflow.kind.startDescription": "Define workflow inputs",
    "settings.workflow.kind.prompt": "Prompt",
    "settings.workflow.kind.promptDescription": "Process and transform text",
    "settings.workflow.kind.agent": "Agent",
    "settings.workflow.kind.agentDescription": "Delegate autonomous work to a model",
    "settings.workflow.kind.condition": "Condition",
    "settings.workflow.kind.conditionDescription": "Route execution based on rules",
    "settings.workflow.kind.tool": "Tool",
    "settings.workflow.kind.toolDescription": "Call a terminal or plugin",
    "settings.workflow.kind.output": "Output",
    "settings.workflow.kind.outputDescription": "Return the final result",
