...
export const translationResources = {
  "zh-CN": {
    ...
    "workflowRun.placeholderSubtitle": "运行工作区占位",
    "workflowRun.placeholderBody": "节点舞台与全图俯瞰将在下一步接入。当前可查看运行进度；产物与人机协作随后到来。",
    ...
    "workflowRun.deployDescription": "将“{{name}}”部署到项目：每个项目对同一工作流只保留一份挂载；每次确认都会在侧栏新建一次运行。",
    ...
    "workflowRun.deployHintFirst": "将挂载此工作流，并创建该项目下的首次运行。",
    "workflowRun.deployHintRemount": "此项目已挂载该工作流。确认后会更新定义快照，并再创建一次新运行。",
    "workflowRun.deployConfirmFirst": "挂载并运行",
  ...
  "en-US": {
    ...
    "workflowRun.placeholderSubtitle": "Run workspace placeholder",
    "workflowRun.placeholderBody": "Theater and graph overview arrive next. You can already watch run progress here; artifacts and HITL follow after that.",
    ...
    "workflowRun.deployDescription": "Deploy “{{name}}” to a project: one mount per project for this workflow; every confirm creates a new sidebar run.",
    ...
    "workflowRun.deployHintFirst": "Mount this workflow and create the first run under the project.",
    "workflowRun.deployHintRemount": "Already mounted here. Confirm refreshes the definition snapshot and creates another run.",
    "workflowRun.deployConfirmFirst": "Mount and run",
